  ...
  return (
    <Layout user={props.user}>
      ...
      <div className='body-imgs'>
        <Link to='/products'><img src='https://res.cloudinary.com/dfryxohde/image/upload/v1634141563/SOUND/stereo-sound-speaker-neon-colored-background_77190-6921_h84lhk.png' alt='stereo' /></Link>
